...
main() {
  test('Test current year format', () {
    ...
    expect(formatted(DateTime.parse('$currentYear-01-07T00:07:55')),
    ...
    expect(formatted(wednesdayDate), matches(RegExp(r'^7:17 Wed May \d\d$')));
  });
  test('Test past year format', () {
    expect(formatted(DateTime.parse('2018-11-13T15:07:55.123')),
